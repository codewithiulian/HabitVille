...
## The Game Where Your Habits Build Your City

HabitVille is a gamified habit tracker where every habit you complete earns you rewards that you use to build and grow an isometric city. The more consistent you are with your habits, the bigger, richer, and more populated your city becomes. Your city is a living reflection of your effort — not a scoreboard that punishes you for missing a day.
...
When you create a new habit, you configure four things:

- **Name**: What the habit is (e.g., "Go to the gym", "Meditate for 10 minutes").
- **Category**: A label that determines the icon and visual theme of the habit card. Categories include Health, Fitness, Learning, Productivity, Mindfulness, Social, and Other.
- **Frequency**: How often the habit should be done — daily, a set number of times per week, on specific days of the week, weekly, or monthly.
- **Difficulty**: How challenging the habit is for you personally, on a three-tier scale:
  - **Easy** — Low effort, low friction. Examples: drink a glass of water, take your vitamins, make your bed.
...
There is no maximum number of habits. Add as many as you like — but the game is designed to reward consistency over quantity.
...
A full check-in with 5 habits should take **under 10 seconds**. The check-in is designed to be the fastest part of your day. The city is the part you linger on.

After completing your check-ins, your city reacts. New construction may appear if you've placed a building, existing buildings may show subtle life, and the city reflects the energy of a productive day.

You can also **backfill yesterday's habits** if you forgot to check in. Life happens — the game doesn't penalise you for logging a day late.
...
Additional XP comes from bonuses (covered in the Bonuses section below).

### XP = Points

XP and Points are the same thing. When you complete a task, you see "+20 XP" because it feels satisfying in the moment. But your lifetime total is also tracked as your **Point total** — a cumulative number that never resets. Your point total is your bragging right: "I'm at 45,000 points." It's the same number as your total XP earned, just viewed as a lifetime achievement.

### Leveling Up

XP accumulates toward your next level. When you hit the threshold, you level up. Leveling up unlocks new asset types in the shop (more on this in the Assets section).

The XP required to level up increases gently as you progress. Early levels are fast to keep you engaged. Later levels take more effort to make them feel earned. But the curve is never steep enough to feel punishing — the difficulty comes from consistency, not from grinding.
...
When you level up, the game makes a big deal of it. A full-screen celebration shows your new level, any assets that just unlocked, and a summary of your progress. Leveling up should feel like an event, not a footnote.
...
Bonuses are the engine that keeps HabitVille exciting past the first week. There are four types of bonuses, and they all stack.
...
The weekly bonus is delivered as part of the **Weekly City Report** (see Analytics section), making it a reward event rather than a background calculation.
...
Throughout normal gameplay, occasional **2x XP events** are triggered at random. These might appear 1–2 times per week and apply to a single check-in session (all habits checked in during that session earn double XP). These are shown with a visual indicator before you start checking in, so you know the boost is active.
...
The initial map provides enough space for a substantial city. Once you reach a certain level, you can unlock **city expansion**, which increases the available map area. This gives you more room to build and serves as a powerful motivational milestone. Details on expansion levels and mechanics are defined in the game configuration.
...
Some assets (notably houses) come in multiple color variants. When you unlock a house type, all color variants of that type become available immediately. This gives you creative flexibility without requiring separate unlock events for each color.
...
**People sprites** are drawn from a pool of 37 character designs and are assigned automatically. You don't choose which people appear — they're a natural consequence of building homes for them.

This mechanic ties the "life" of your city directly to your building decisions. Want a busy, populated downtown? Build apartments. Want a quiet suburban street? Place houses with gardens. The city's personality reflects your choices.

---

## Analytics and Progress

### Weekly City Report (Auto-Triggered)

At the end of each week, a **Weekly City Report** appears automatically. This is designed to take 30 seconds to read and serves as both a review and a reward event. The report includes:
...
The weekly report is not optional homework — it's a celebration. It should feel like opening a results screen at the end of a game level.

### Stats Menu (Always Available)
...
**City Value** is a vanity metric — the sum of the Ville cost of every asset you've placed. It gives users a single number to track and be proud of, like a net worth for your city.
...
Future updates may introduce: multiple cities, seasonal limited-edition assets, community features, trading between players, and more. But the core value — tracking your habits, earning rewards, and building something you're proud of — remains constant whether you're on day 1 or day 1,000.

---

## Design Philosophy

HabitVille is built on a few core beliefs:

1. **Positive reinforcement over punishment.** You earn rewards for doing well. You never lose anything for missing a day. The game pulls you forward — it never pushes you from behind.

2. **Simplicity in action, depth in outcome.** Checking in takes 10 seconds. Building your city is the rich, rewarding part. The effort-to-engagement ratio should always feel balanced.

3. **Consistency is the game.** The difficulty isn't in any single habit — it's in showing up every day. The economy, bonuses, and city growth are all designed to reward the player who keeps coming back, not the player who grinds once and disappears.

4. **Your city is yours.** No two HabitVille cities look the same because no two people have the same habits, consistency, or creative taste. The city is a personal achievement, not a template.

5. **The research behind the game.** HabitVille's mechanics are informed by behavioural science: the habit loop (cue, craving, response, reward), variable reinforcement schedules, the power of visual progress tracking, and the finding that most habit trackers fail because they punish imperfection instead of celebrating effort.
